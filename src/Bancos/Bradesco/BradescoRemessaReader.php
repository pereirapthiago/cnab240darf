...
class BradescoRemessaReader implements RemessaReaderInterface
{
    ...
    private function getHeaderArquivo(): void
    {
        try {
            ...
            $headerLayout = BradescoLayout::getHeaderArquivoLayout();
            $header = [];
    ...
    private function getHeaderLote(): void
    {
        try {
            ...
            $headerLoteLayout = BradescoLayout::getHeaderLoteLyout();
            $headerLote = [];
    ...
    private function getLinhasLote(): void
    {
        try {
            ...
            $lote = [];
            $headerLayout = BradescoLayout::getLoteLayout();
    ...
    public function getTrailerLote(): void
    {
        try {
            ...
            $layoutTrailerLote = BradescoLayout::getTrailerLoteLayout();
    ...
    private function getTrailerArquivo(): void
    {
        try {
            ...
            $layoutTrailerArquivo = BradescoLayout::getTrailerArquivoLayout();
