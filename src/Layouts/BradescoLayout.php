...
class BradescoLayout
{
    ...
    public static function getHeaderLoteLyout(): array{
        return [
            ...
            ['start' => 223, 'end' => 224, 'name' => 'ind_forma_pag_compr', 'length' => 02, 'description' => 'Indicativo da Forma de Pagamento do Compromisso = 01', 'type' => 'numeric'],
    ...
    public static function getLoteLayout(): array
    {
        return [
            ...
            ['start' => 111, 'end' => 116, 'name' => 'referencia', 'length' => 6, 'description' => 'Código da Receita do Tributo', 'type' => 'alpha'],
            ['start' => 117, 'end' => 118, 'name' => 'tipo_identificacao', 'length' => 2, 'description' => 'Tipo de Identificação do Contribuinte = 01', 'type' => 'numeric'],
            ['start' => 119, 'end' => 132, 'name' => 'cpf_contribuinte', 'length' => 14, 'description' => 'CPF/CNPJ do contribuinte', 'type' => 'numeric'],
            ['start' => 133, 'end' => 134, 'name' => 'identificacao_tributo', 'length' => 2, 'description' => 'Código de Identificação do Tributo = 16', 'type' => 'alpha'],
            ['start' => 135, 'end' => 142, 'name' => 'periodo_apuracao', 'length' => 8, 'description' => 'Período de Apuração', 'type' => 'numeric'],
            ['start' => 143, 'end' => 159, 'name' => 'referencia', 'length' => 8, 'description' => 'Número de Referência', 'type' => 'numeric'],
            ...
            ['start' => 213, 'end' => 230, 'name' => 'uso_febraban', 'length' => 21, 'description' => 'Uso febrabran', 'type' => 'alpha'],
